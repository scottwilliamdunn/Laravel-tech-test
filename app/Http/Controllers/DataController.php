...
class DataController extends Controller
{
    ...
    private static function consumeToDatabase($business_type_id, $start_time)
    {
        ...
        $total_pages = Http::withHeaders(['x-api-version' => '2'])->get(
            "http://api.ratings.food.gov.uk/Establishments?businessTypeId={$business_type_id}&maxDistanceLimit=20&sortOptionKey=Distance&pageNumber=0&pageSize=200"
        ...
        for($page_number = 1; $page_number <= $total_pages; $page_number++) {
            ...
            $response = Http::withHeaders(['x-api-version' => '2'])->get(
                "http://api.ratings.food.gov.uk/Establishments?businessTypeId={$business_type_id}&maxDistanceLimit=20&sortOptionKey=Distance&pageNumber={$page_number}&pageSize=200"
            )->json()['establishments'];
